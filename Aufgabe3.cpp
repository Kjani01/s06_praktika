...
void CreateGeometry()
{
	...
	auto drawVertices = new M3DVector3f[48];


	//m3dLoadVector3(bodenVertices[0], 0, 0, 0);


	//Berechnung der Punkte für beide Deckel
	int i = 0;
	...
	for (i = 1; i < (4 * tesselierung + 1); i++) {
		...
		m3dLoadVector3(drawVertices[laufvariable], bodenVertices[i - 1][0], bodenVertices[i - 1][1], bodenVertices[i - 1][2]);
		laufvariable++;
		...
		m3dLoadVector3(drawVertices[laufvariable], 0.0, 0.0, 0.0);	//Startpunkt
		laufvariable++;
		if (i < (4 * tesselierung)) {
			...
			m3dLoadVector3(drawVertices[laufvariable], bodenVertices[i][0], bodenVertices[i][1], bodenVertices[i][2]);
			laufvariable++;
	...
	m3dLoadVector3(drawVertices[laufvariable], bodenVertices[0][0], bodenVertices[0][1], bodenVertices[0][2]);
	laufvariable++;
	...
	for (i = 1; i < (4 * tesselierung + 1); i++) {
		...
		//float zV = -0.25;
		//geometryBatch.Normal3f(xV, yV, zV);
		printf("Current point: %f, %f, %f\n", boden2Vertices[i - 1][0], boden2Vertices[i - 1][1], boden2Vertices[i - 1][2]);
		m3dLoadVector3(drawVertices[laufvariable], boden2Vertices[i - 1][0], boden2Vertices[i - 1][1], boden2Vertices[i - 1][2]);
		laufvariable++;
		...
		if (i < (4 * tesselierung)) {
			...
			//zV = 0.0;
			//geometryBatch.Normal3f(xV, yV, zV);
			printf("Current point: %f, %f, %f\n", boden2Vertices[i][0], boden2Vertices[i][1], boden2Vertices[i][2]);

			m3dLoadVector3(drawVertices[laufvariable], boden2Vertices[i][0], boden2Vertices[i][1], boden2Vertices[i][2]);
			laufvariable++;
			//normVecs.Vertex3f(bodenVertices[i][0], bodenVertices[i][1], bodenVertices[i][2]);
			//normVecs.Vertex3f(bodenVertices[i][0] * 2.0, bodenVertices[i][1] * 2.0, bodenVertices[i][2]);
		}
	...
	//float zV = 0.0;
	//geometryBatch.Normal3f(xV, yV, zV);
	printf("Current point: %f, %f, %f\n", boden2Vertices[0][0], boden2Vertices[0][1], boden2Vertices[0][2]);

	m3dLoadVector3(drawVertices[laufvariable], boden2Vertices[0][0], boden2Vertices[0][1], boden2Vertices[0][2]);
	laufvariable++;
...
/*
	...
	*/
	...
	geometryBatch.CopyVertexData3f(drawVertices);
	//geometryBatch.CopyVertexData3f(boden2Vertices);
