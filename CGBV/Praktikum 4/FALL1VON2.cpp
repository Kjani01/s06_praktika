...
void CreateGeometry()
{
	...
	if (alphaWinkel == 1) {
		...
		for (i = 1; i < (4 * tesselierung + 1); i++) {
			...
			normVecs.Vertex3f(boden2Vertices[i - 1][0] + 0, boden2Vertices[i - 1][1] + 0, boden2Vertices[i - 1][2] + 1);
			...
			if (i < (4 * tesselierung)) {
				...
				normVecs.Vertex3f(boden2Vertices[i][0] + 0, boden2Vertices[i][1] + 0, boden2Vertices[i][2] + 1);
			}
		}
		...
		normVecs.Vertex3f(boden2Vertices[0][0] + 0, boden2Vertices[0][1] + 0, boden2Vertices[0][2] + 1);
		...
		for (i = 0; i < (4 * tesselierung); i++) {
			...
			if (i == 0) {
				...
				normVecs.Vertex3f(bodenVertices[i % (4 * tesselierung)][0] + 0, bodenVertices[i % (4 * tesselierung)][1] + 0, bodenVertices[i % (4 * tesselierung)][2] + 1);
				...
				normVecs.Vertex3f(boden2Vertices[(i + 1) % (4 * tesselierung)][0] + 0, boden2Vertices[(i + 1) % (4 * tesselierung)][1] + 0, boden2Vertices[(i + 1) % (4 * tesselierung)][2] + 1);
		...
		for (i = 1; i < (4 * tesselierung + 1); i++) {
			...
			normVecs.Vertex3f(bodenVertices[i - 1][0] + 0, bodenVertices[i - 1][1] + 0, bodenVertices[i - 1][2] + 1);
			...
			if (i < (4 * tesselierung)) {
				...
				normVecs.Vertex3f(bodenVertices[i][0] + 0, bodenVertices[i][1] + 0, bodenVertices[i][2] + 1);
			}
		}
		...
		normVecs.Vertex3f(bodenVertices[0][0] + 0, bodenVertices[0][1] + 0, bodenVertices[0][2] + 1);*/

	}
	else if (alphaWinkel == 2) {		//zwischen Boden und Mantel eine Kante, Mantel rund

	//geometryBatch.Normal3f(boden2Vertices[0][0], boden2Vertices[0][1], 0);
		//normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0); //das sind die Vektoren für Fall 2!
		//normVecs.Vertex3f(boden2Vertices[0][0]+boden2Vertices[0][0], boden2Vertices[0][1]+boden2Vertices[0][1], 1.0);
		/*****************
