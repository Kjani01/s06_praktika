...
void CreateGeometry()
{
	...
	if (alphaWinkel == 1) {
		...
		geometryBatch.Normal3f(0, 0, 1);
		geometryBatch.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 1.0);
		geometryBatch.Normal3f(0, 0, 1);
		geometryBatch.Vertex3f(0.0, 0.0, 1.0);
		geometryBatch.Normal3f(0, 0, 1);
		geometryBatch.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0);

		normVecs.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[7][0] + 0, boden2Vertices[7][1] + 0, 1.0 + 1);
		normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[0][0] + 0, boden2Vertices[0][1] + 0, 1.0 + 1);
		...
		geometryBatch.Normal3f(0, 0, -1);
		geometryBatch.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 0.0);
		geometryBatch.Normal3f(0, 0, -1);
		geometryBatch.Vertex3f(0.0, 0.0, 0.0);
		geometryBatch.Normal3f(0, 0, -1);
		geometryBatch.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 0.0);

		normVecs.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 0.0);
		normVecs.Vertex3f(boden2Vertices[7][0] + 0, boden2Vertices[7][1] + 0, 0.0 - 1);
		normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 0.0);
		normVecs.Vertex3f(boden2Vertices[0][0] + 0, boden2Vertices[0][1] + 0, 0.0 - 1);

		// MANTEL
		M3DVector3f kreuzprod;
		M3DVector3f vecU;
		M3DVector3f vecV;
		...
		m3dLoadVector3(vecU, boden2Vertices[0][0] - bodenVertices[7][0], boden2Vertices[0][1] - bodenVertices[7][1], 1.0 - 0.0);
		m3dLoadVector3(vecV, boden2Vertices[0][0] - boden2Vertices[7][0], boden2Vertices[0][1] - boden2Vertices[7][1], 1.0 - 1.0);
		m3dCrossProduct3(kreuzprod, vecU, vecV);
		m3dNormalizeVector3(kreuzprod);

		//PUNKT der anfang vom ende
		geometryBatch.Normal3f(kreuzprod[0], kreuzprod[1], kreuzprod[2]);
		geometryBatch.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[7][0] + kreuzprod[0], boden2Vertices[7][1] + kreuzprod[1], 1.0 + kreuzprod[2]);

		//PUNKT und der davor
		geometryBatch.Normal3f(kreuzprod[0], kreuzprod[1], kreuzprod[2]);
		geometryBatch.Vertex3f(bodenVertices[7][0], bodenVertices[7][1], 0.0);
		normVecs.Vertex3f(bodenVertices[7][0], bodenVertices[7][1], 0.0);
		normVecs.Vertex3f(bodenVertices[7][0] + kreuzprod[0], bodenVertices[7][1] + kreuzprod[1], 0.0 + kreuzprod[2]);

		//PUNKT der davor
		geometryBatch.Normal3f(kreuzprod[0], kreuzprod[1], kreuzprod[2]);
		geometryBatch.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[0][0] + kreuzprod[0], boden2Vertices[0][1] + kreuzprod[1], 1.0 + kreuzprod[2]);
		...
		//PUNKT letzt
		geometryBatch.Normal3f(kreuzprod[0], kreuzprod[1], kreuzprod[2]);
		geometryBatch.Vertex3f(bodenVertices[0][0], bodenVertices[0][1], 0.0);
		normVecs.Vertex3f(bodenVertices[0][0], bodenVertices[0][1], 0.0);
		normVecs.Vertex3f(bodenVertices[0][0] + kreuzprod[0], bodenVertices[0][1] + kreuzprod[1], 0.0 + kreuzprod[2]);



	}
	else if (alphaWinkel == 2) {		
		...
		for (i = 0; i < 7; i++) {
			...
			//PUNKT 5
			m3dLoadVector3(lightVec, bodenVertices[i + 1][0], bodenVertices[i + 1][1], 0.0);
			m3dNormalizeVector3(lightVec);

			geometryBatch.Normal3f(lightVec[0], lightVec[1], lightVec[2]);
			geometryBatch.Vertex3f(bodenVertices[i + 1][0], bodenVertices[i + 1][1], 0.0);
			normVecs.Vertex3f(bodenVertices[i + 1][0], bodenVertices[i + 1][1], 0.0);
			normVecs.Vertex3f(bodenVertices[i + 1][0] + lightVec[0], bodenVertices[i + 1][1] + lightVec[1], 0.0 + lightVec[2]);
		}

		//PUNKT 0
		m3dLoadVector3(lightVec, boden2Vertices[7][0], boden2Vertices[7][1], 0.0);
		m3dNormalizeVector3(lightVec);

		geometryBatch.Normal3f(lightVec[0], lightVec[1], lightVec[2]);
		geometryBatch.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[7][0] + lightVec[0], boden2Vertices[7][1] + lightVec[1], 1.0 + lightVec[2]);

		//PUNKT 1
		m3dLoadVector3(lightVec, bodenVertices[7][0], bodenVertices[7][1], 0.0);
		m3dNormalizeVector3(lightVec);

		geometryBatch.Normal3f(lightVec[0], lightVec[1], lightVec[2]);
		geometryBatch.Vertex3f(bodenVertices[7][0], bodenVertices[7][1], 0.0);
		normVecs.Vertex3f(bodenVertices[7][0], bodenVertices[7][1], 0.0);
		normVecs.Vertex3f(bodenVertices[7][0] + lightVec[0], bodenVertices[7][1] + lightVec[1], 0.0 + lightVec[2]);

		//PUNKT 2
		m3dLoadVector3(lightVec, boden2Vertices[0][0], boden2Vertices[0][1], 0.0);
		m3dNormalizeVector3(lightVec);

		geometryBatch.Normal3f(lightVec[0], lightVec[1], lightVec[2]);
		geometryBatch.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0);
		normVecs.Vertex3f(boden2Vertices[0][0] + lightVec[0], boden2Vertices[0][1] + lightVec[1], 1.0 + lightVec[2]);
		...
		//PUNKT 5
		m3dLoadVector3(lightVec, bodenVertices[0][0], bodenVertices[0][1], 0.0);
		m3dNormalizeVector3(lightVec);

		geometryBatch.Normal3f(lightVec[0], lightVec[1], lightVec[2]);
		geometryBatch.Vertex3f(bodenVertices[0][0], bodenVertices[0][1], 0.0);
		normVecs.Vertex3f(bodenVertices[0][0], bodenVertices[0][1], 0.0);
		normVecs.Vertex3f(bodenVertices[0][0] + lightVec[0], bodenVertices[0][1] + lightVec[1], 0.0 + lightVec[2]);


	}
	else if (alphaWinkel == 3) {
		...
		for (i = 0; i < 7; i++) {
			...
			//normVecs.Vertex3f(boden2Vertices[i][0], boden2Vertices[i][1], 1.0);
			//normVecs.Vertex3f(boden2Vertices[i][0] + lightVec[0], boden2Vertices[i][1] + lightVec[1], 1.0 + lightVec[2]);
			m3dLoadVector3(vec1, boden2Vertices[i][0] + lightVec[0], boden2Vertices[i][1] + lightVec[1], 1.0 + lightVec[2]);
			//normVecs.Vertex3f(boden2Vertices[i][0], boden2Vertices[i][1], 1.0);
			//normVecs.Vertex3f(boden2Vertices[i][0] + 0, boden2Vertices[i][1] + 0, 1.0 + 1);
			m3dLoadVector3(vec2, boden2Vertices[i][0] + 0, boden2Vertices[i][1] + 0, 1.0 + 1);
			...
			//normVecs.Vertex3f(boden2Vertices[i + 1][0], boden2Vertices[i + 1][1], 1.0);
			//normVecs.Vertex3f(boden2Vertices[i + 1][0] + lightVec[0], boden2Vertices[i + 1][1] + lightVec[1], 1.0 + lightVec[2]);
			m3dLoadVector3(vec1, boden2Vertices[i + 1][0] + lightVec[0], boden2Vertices[i + 1][1] + lightVec[1], 1.0 + lightVec[2]);
			//normVecs.Vertex3f(boden2Vertices[i + 1][0], boden2Vertices[i + 1][1], 1.0);
			//normVecs.Vertex3f(boden2Vertices[i + 1][0] + 0, boden2Vertices[i + 1][1] + 0, 1.0 + 1);
			m3dLoadVector3(vec2, boden2Vertices[i + 1][0] + 0, boden2Vertices[i + 1][1] + 0, 1.0 + 1);
			m3dAddVectors3(add, vec1, vec2);
			normVecs.Vertex3f(boden2Vertices[i + 1][0], boden2Vertices[i + 1][1], 1.0);
			normVecs.Vertex3f(add[0], add[1], add[2]);
		...
		//normVecs.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 1.0);
		//normVecs.Vertex3f(boden2Vertices[7][0] + lightVec[0], boden2Vertices[7][1] + lightVec[1], 1.0 + lightVec[2]);
		m3dLoadVector3(vec1, boden2Vertices[7][0] + lightVec[0], boden2Vertices[7][1] + lightVec[1], 1.0 + lightVec[2]);
		//normVecs.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 1.0);
		//normVecs.Vertex3f(boden2Vertices[7][0] + 0, boden2Vertices[7][1] + 0, 1.0 + 1);
		m3dLoadVector3(vec2, boden2Vertices[7][0] + 0, boden2Vertices[7][1] + 0, 1.0 + 1);
		m3dAddVectors3(add, vec1, vec2);
		normVecs.Vertex3f(boden2Vertices[7][0], boden2Vertices[7][1], 1.0);
		normVecs.Vertex3f(add[0], add[1], add[2]);
		...
		//normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0);
		//normVecs.Vertex3f(boden2Vertices[0][0] + lightVec[0], boden2Vertices[0][1] + lightVec[1], 1.0 + lightVec[2]);
		m3dLoadVector3(vec1, boden2Vertices[0][0] + lightVec[0], boden2Vertices[0][1] + lightVec[1], 1.0 + lightVec[2]);
		//normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0);
		//normVecs.Vertex3f(boden2Vertices[0][0] + 0, boden2Vertices[0][1] + 0, 1.0 + 1);
		m3dLoadVector3(vec2, boden2Vertices[0][0] + 0, boden2Vertices[0][1] + 0, 1.0 + 1);
		m3dAddVectors3(add, vec1, vec2);
		normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 1.0);
		normVecs.Vertex3f(add[0], add[1], add[2]);
		...
		for (i = 0; i < 7; i++) {
			...
			//normVecs.Vertex3f(bodenVertices[i][0], bodenVertices[i][1], 0.0);
			//normVecs.Vertex3f(bodenVertices[i][0] + 0, bodenVertices[i][1] + 0, 0.0 - 1);
			...
			//normVecs.Vertex3f(bodenVertices[i + 1][0], bodenVertices[i + 1][1], 0.0);
			//normVecs.Vertex3f(bodenVertices[i + 1][0] + lightVec[0], bodenVertices[i + 1][1] + lightVec[1], 0.0 + lightVec[2]);
			m3dLoadVector3(vec1, bodenVertices[i + 1][0] + lightVec[0], bodenVertices[i + 1][1] + lightVec[1], 0.0 + lightVec[2]);
			//normVecs.Vertex3f(bodenVertices[i + 1][0], bodenVertices[i + 1][1], 0.0);
			//normVecs.Vertex3f(bodenVertices[i + 1][0] + 0, bodenVertices[i + 1][1] + 0, 0.0 - 1);
			m3dLoadVector3(vec2, bodenVertices[i + 1][0] + 0, bodenVertices[i + 1][1] + 0, 0.0 - 1);
			m3dAddVectors3(add, vec1, vec2);
			normVecs.Vertex3f(bodenVertices[i + 1][0], bodenVertices[i + 1][1], 0.0);
			normVecs.Vertex3f(add[0], add[1], add[2]);
		...
		//normVecs.Vertex3f(bodenVertices[7][0], bodenVertices[7][1], 0.0);
		//normVecs.Vertex3f(bodenVertices[7][0] + lightVec[0], bodenVertices[7][1] + lightVec[1], 0.0 + lightVec[2]);
		m3dLoadVector3(vec1, bodenVertices[7][0] + lightVec[0], bodenVertices[7][1] + lightVec[1], 0.0 + lightVec[2]);
		//normVecs.Vertex3f(bodenVertices[7][0], bodenVertices[7][1], 1.0);
		//normVecs.Vertex3f(bodenVertices[7][0] + 0, bodenVertices[7][1] + 0, 0.0 - 1);
		m3dLoadVector3(vec2, bodenVertices[7][0] + 0, bodenVertices[7][1] + 0, 0.0 - 1);
		m3dAddVectors3(add, vec1, vec2);
		normVecs.Vertex3f(bodenVertices[7][0], bodenVertices[7][1], 0.0);
		normVecs.Vertex3f(add[0], add[1], add[2]);
		...
		m3dNormalizeVector3(lightVec);
		//normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 0.0);
		//normVecs.Vertex3f(boden2Vertices[0][0] + lightVec[0], boden2Vertices[0][1] + lightVec[1], 0.0 + lightVec[2]);
		m3dLoadVector3(vec1, boden2Vertices[0][0] + lightVec[0], boden2Vertices[0][1] + lightVec[1], 0.0 + lightVec[2]);
		//normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 0.0);
		//normVecs.Vertex3f(boden2Vertices[0][0] + 0, boden2Vertices[0][1] + 0, 0.0 - 1);
		m3dLoadVector3(vec2, boden2Vertices[0][0] + 0, boden2Vertices[0][1] + 0, 0.0 - 1);
		m3dAddVectors3(add, vec1, vec2);
		normVecs.Vertex3f(boden2Vertices[0][0], boden2Vertices[0][1], 0.0);
		normVecs.Vertex3f(add[0], add[1], add[2]);
		...
		//normVecs.Vertex3f(bodenVertices[0][0], bodenVertices[0][1], 0.0);
		//normVecs.Vertex3f(bodenVertices[0][0] + lightVec[0], bodenVertices[0][1] + lightVec[1], 0.0 + lightVec[2]);
		m3dLoadVector3(vec1, bodenVertices[0][0] + lightVec[0], bodenVertices[0][1] + lightVec[1], 0.0 + lightVec[2]);
		//normVecs.Vertex3f(bodenVertices[0][0], bodenVertices[0][1], 0.0);
		//normVecs.Vertex3f(bodenVertices[0][0] + 0, bodenVertices[0][1] + 0, 0.0 - 1);
		m3dLoadVector3(vec2, bodenVertices[0][0] + 0, bodenVertices[0][1] + 0, 0.0 - 1);
		m3dAddVectors3(add, vec1, vec2);
		normVecs.Vertex3f(bodenVertices[0][0], bodenVertices[0][1], 0.0);
		normVecs.Vertex3f(add[0], add[1], add[2]);
		...
		geometryBatch.Vertex3f(bodenVertices[0][0], bodenVertices[0][1], 0.0);
			...
			//normVecs.Vertex3f(boden2Vertices[i][0], boden2Vertices[i][1], 1.0);
			//normVecs.Vertex3f(add[0] + kreuzprod[0], add[1] + kreuzprod[1], add[2] + kreuzprod[2]);
			//normVecs.Vertex3f(boden2Vertices[i + 1][0], boden2Vertices[i + 1][1], 1.0);
			//normVecs.Vertex3f(add[0] + kreuzprod[0], add[1] + kreuzprod[1], add[2] + kreuzprod[2]);
